$(document).ready(function () {
    ...
    $imageScreen.css('background-image', `url('https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/showdown/${data.id}.gif')`);
    ...
    $aboutScreen.text(`Height: ${data.height * 10}cm Weight: ${data.weight / 10}kg Ability: ${data.abilities[0].ability.name}`);
    $inputField.val('');
    }
    });
    }
